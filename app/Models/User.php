...
#[Fillable(['name', 'email', 'password', 'role', 'onboarding_completed', 'preferred_mood', 'therapy_concerns', 'therapy_preference', 'license_number', 'specialization', 'years_of_experience', 'bio'])]
