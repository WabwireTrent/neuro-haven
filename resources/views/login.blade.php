...
<aside class="auth-panel" aria-hidden="true">
  <!-- Dark teal overlay for left side -->
  ...
  <div class="auth-panel__inner">
    ...
    <h2 class="auth-panel__headline">Your mind deserves a safe place to breathe.</h2>
    <p class="auth-panel__sub">Uganda's first VR-assisted mental wellness platform. Private, stigma-free, and built for you.</p>
...
<div class="auth-wrap">
  <section class="auth-card" aria-labelledby="login-heading">
    ...
    <nav class="auth-tabs" aria-label="Authentication pages">
      ...
      <a class="auth-tab is-active" href="{{ route('login') }}" aria-current="page">Log In</a>
    </nav>
    ...
    <div class="auth-content">
      ...
      <form class="auth-form" method="POST" action="{{ route('login.post') }}" data-validate novalidate>
        @csrf
        ...
        <div class="input-group input-group--icon">
          ...
          <div class="input-wrap">
            ...
            <button class="input-eye" type="button" aria-label="Show password" data-pw-toggle="login-password">
