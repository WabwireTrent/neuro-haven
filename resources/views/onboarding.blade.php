...
<main class="onboarding-shell">
  <div class="onboarding-app">
    <header class="onboarding-head">
      <button class="onboarding-back" type="button" data-onboarding-back aria-label="Go to previous step">
        <svg aria-hidden="true" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <polyline points="15 18 9 12 15 6"/>
        </svg>
      </button>
      <div class="onboarding-brand">Neuro Haven</div>
    </header>

    <section class="onboarding-progress" aria-label="Assessment progress">
      <div class="onboarding-progress__meta">
        <p class="onboarding-progress__label">Wellness Assessment</p>
        <p class="onboarding-progress__step" data-onboarding-step-label>Step 1 of 4</p>
      </div>
      <div class="onboarding-progress__bar" aria-hidden="true">
        <div class="onboarding-progress__value" data-onboarding-progress></div>
      </div>
    </section>

    <section class="onboarding-body">
      <article class="onboarding-card" data-onboarding-card>
        <p class="onboarding-eyebrow" data-onboarding-eyebrow>Welcome</p>
        <h1 class="onboarding-title" data-onboarding-title>Preparing your wellness path</h1>
        <p class="onboarding-subtitle" data-onboarding-subtitle>We are getting your personalized experience ready.</p>
        <div data-onboarding-content></div>
        <p class="onboarding-alert" data-onboarding-error aria-live="polite"></p>
      </article>
    </section>

    <footer class="onboarding-actions">
      <button class="btn btn-ghost" type="button" data-onboarding-prev>Back</button>
...
(function () {
  ...
  function goNext() {
    ...
    localStorage.setItem('nh_onboarding_data', JSON.stringify({
      mood: state.mood,
      concerns: state.concerns,
      preference: state.preference
    }));

    // Submit onboarding data via AJAX or redirect
